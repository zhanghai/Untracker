            ...
            listOf(
                ...
                Rule(
                    ...
                    script =
                        """
                        while (true) {
                            if ($.matches(url, '163cn\\.tv|a\\.co|amzn\\.(asia|eu|to)|b23\\.tv|bili2233\\.cn|v\\.douyin\\.com|dwz\\.cn|u\\.jd\\.com|v\\.kuaishou\\.com|pin\\.it|share\\.google|t\\.cn|vm\\.tiktok\\.com|url\\.cn|xhslink\\.(cn|com)')
